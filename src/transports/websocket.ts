    ...
    ws.on('message', async (data: Buffer) => {
      try {
        ...
        try {
          ...
          formatBox('▼ MCP REQUEST (WebSocket)', request, 'bgBlue', 'brightCyan');
        } catch (e) {
        ...
        try {
          ...
          formatBox('▲ MCP RESPONSE (WebSocket)', response, 'bgGreen', 'brightGreen');
          ...
          formatBox('▲ MCP ERROR RESPONSE (WebSocket)', errorResponse, 'bgRed', 'brightRed');
